...
<form role="form" method="POST" action="">
	<fieldset class="scheduler-border">
		<legend class="scheduler-border">REGISTRO DE CONCEPTO DE PAGO</legend>
			<div class="row">
		        <div class="col-lg-12">
		                        ...
		                        <div class="col-lg-12">
		                            <div class="col-sm-4 col-sm-offset-4 ">
		                                <div class="form-group">
		                                    ...
		                                    <input name="codcon" id="descon" type="hidden" class="form-control" value="con00009">
		                                </div>
		                            </div>
		                            ...
		                            <div class="col-sm-4 col-sm-offset-4">
		                                <div class="form-group">
		                                	...
		                                	<input name="descon" id="descon" type="text" class="form-control">
		                                	<p class="help-block">Ingrese descripcion de pago.</p>
		                          		</div>
		                            </div>
																<div class="col-sm-4 col-sm-offset-4">
																	 <div class="form-group">
																	 <label>Monto</label>
																		 ...
																		 <p class="help-block">Ingrese monto.</p>
																 </div>
															 </div>
