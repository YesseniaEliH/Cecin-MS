...
<body>
	<div class="row fondo">
		<div class="col-sm-10 col-md-10 col-lg-10">
			<h1 class="text-center text-uppercase">Gestión de docentes</h1>
		</div>
		<div class="col-sm-2 col-md-2 col-lg-2 verticalYess">
			<a href="docente-nuevo.php" class="btn btn-primary active" role="button">Nuevo Docente</a>
		</div>
	</div>
	...
	<div class="row">
		<div id="cuadro2" class="col-sm-12 col-md-12 col-lg-12 ocultar">
			<form class="form-horizontal" action="" method="POST">
				...
				<input type="hidden" id="coddoc" name="coddoc" value="0">
        ...
        <div class="form-group">
          <label for="nrodocd" class="col-sm-2 control-label">Nro de Documento</label>
          <div class="col-sm-8"><input name="nrodocd" id="nrodocd"  type="text" class="form-control" ></div>
        </div>
				<div class="form-group">
	...
	<div class="row">
		<div id="cuadro1" class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="table-responsive col-sm-12">
				<table id="t_docente" class="table table-bordered table-hover" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Dni</th>
							<th>Nombres</th>
	...
	<div>
		<form id="frmEliminarUsuario" action="" method="POST">
			<input type="hidden" id="coddoc" name="coddoc" value="">
	...
	<script>
		...
		var eliminar = function(){
			$("#eliminar-usuario").on("click", function(){
				var coddoc = $("#frmEliminarUsuario #coddoc").val(),
					opcion = $("#frmEliminarUsuario #opcion").val();
				$.ajax({
					method:"POST",
					url: "docentes-eliminar.php",
					data: {"coddoc": coddoc, "opcion": opcion}
				}).done( function( info ){
					var json_info = JSON.parse( info );
					mostrar_mensaje( json_info );
					limpiar_datos();
      ...
      $("#direcdoc").val("");
		...
		var listar = function(){
			...
			var table = $("#t_docente").DataTable({
				"destroy":true,
				"ajax":{
					"method":"POST",
					"url": "docentes-listar.php"
				},
				"columns":[
					{"data":"nrodocd"},
					{"data":"nomdoc"},
          ...
          {"data":"direcdoc"},
			...
			obtener_data_editar("#t_docente tbody", table);
			obtener_id_eliminar("#t_docente tbody", table);
		}
		...
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				...
				var coddoc = $("#coddoc").val( data.coddoc ),
            tipodoc = $("#tipodoc").val( data.tipodoc ),
            nrodocd = $("#nrodocd").val( data.nrodocd ),
						nomdoc = $("#nomdoc").val( data.nomdoc ),
						appdoc = $("#appdoc").val( data.appdoc ),
            apmdoc = $("#apmdoc").val( data.apmdoc ),
						teldoc = $("#teldoc").val( data.teldoc ),
            direcdoc = $("#direcdoc").val( data.direcdoc ),
		...
		var obtener_id_eliminar = function(tbody, table){
			$(tbody).on("click", "button.eliminar", function(){
				var data = table.row( $(this).parents("tr") ).data();
				var coddoc = $("#frmEliminarUsuario #coddoc").val( data.coddoc );
			});
		}
